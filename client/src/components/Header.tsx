  ...
  return (
    <header className="header-modern sticky top-0 z-50">
      ...
      <div className="flex items-center space-x-4">
        ...
        {/* Settings */}
        <button className="p-3 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all duration-200 hover:scale-110 transform focus:outline-none focus:ring-4 focus:ring-blue-500/50">
          <svg className="w-5 h-5 text-slate-600 dark:text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
